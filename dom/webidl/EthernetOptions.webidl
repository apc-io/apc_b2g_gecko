...
/**
  * This dictionnary holds the parameters sent to the Ethernet service.
  */
dictionary EthernetCommandOptions
{
  long      id = 0;       // opaque id.
...
/**
  * This dictionnary holds the parameters sent back to EthernetWorker.js
  */
dictionary EthernetResultOptions
{
  long      id = 0;             // opaque id.
  ...
  long      dns2 = 0;
  long      server = 0;
  boolean      cableConnected = false; // for getEthernetStats
  boolean      up = false;             // for getEthernetStats
};
